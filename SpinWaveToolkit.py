...
#        return f
    ...
    def GetLifetimeSAFM(self, n=3):
        ...
        """
        BextOri = self.Bext
        self.Bext = BextOri*0.9999999+0.00001
        dw0p999 = self.GetDispersionSAFMNumeric()
        self.Bext = BextOri*1.0000001-0.00001
        dw0p001 = self.GetDispersionSAFMNumeric()
        self.Bext = BextOri
        w = self.GetDispersionSAFMNumeric()
        lifetime = ((self.alpha*w[n,:] + self.gamma*self.mu0dH0)*(dw0p001[n,:] - dw0p999[n,:])/((BextOri*1.0000001+0.00001) - (BextOri*0.9999999-0.00001)))**-1
        return lifetime
